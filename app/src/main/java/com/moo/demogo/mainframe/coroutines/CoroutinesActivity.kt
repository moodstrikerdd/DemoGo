...
//                        val encode = Base64Utils.encode("abcdef".toByteArray(), Base64Utils.DEFAULT)
//                        val toString = encode.toString(Charsets.UTF_8)
//                        loge(message = encode.toString(Charsets.UTF_8))
//                        loge(message = Base64Utils.decode(toString, Base64Utils.DEFAULT).toString(Charsets.UTF_8))
